...
INSERT INTO CRICKET(Name,City,Age) VALUES ('Jay Patel ','Rajkot ',30),('Rahul Dave','Baroda',35),('Jeet Patel','Surat',31),('Vijay Raval','Rajkot',30); 
...
--5
UPDATE BORROW
SET AMOUNT = 5000 , CNAME = 'DARSHAN', BNAME = 'VRCE'
WHERE LOANNO = 481
SELECT * FROM BORROW
