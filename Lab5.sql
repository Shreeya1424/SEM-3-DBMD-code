...
INSERT INTO STUDENT (StuID,FirstName,LastName,Website,City,Address) VALUES	(1022,'HARDIK','SHAH','digminecraft.com', 'AHEMDABAD','"Ram Krupa", Raiya Road');
...
INSERT INTO STUDENT (StuID,FirstName,LastName,Website,City,Address) VALUES	(1044,'BHOOMI','GAJERA','checkyourmath.com', 'AHEMDABAD','"Jig’s Home", Narol');
...
--5. Display all the students whose first name starts with ‘ha’ & ends with‘t’.  BFYT
...
SELECT * FROM STUDENT WHERE WEBSITE LIKE'[A-Z,@]%'
...
SELECT * FROM STUDENT WHERE CITY LIKE'K%'
